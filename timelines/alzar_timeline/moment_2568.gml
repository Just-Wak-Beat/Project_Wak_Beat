...
{
yonsei_hitbox = instance_create_depth(room_width*0.5,global.c_h,obj_player.depth-1,hitbox_11)
...
spotlight1 = instance_create_depth(room_width*0.3,global.c_y+64,obj_player.depth-1,hitbox_11)
...
spotlight2 = instance_create_depth(room_width*0.7,global.c_y+64,obj_player.depth-1,hitbox_11)
...
create_explo_circle(room_width*0.3,room_height*0.35,60-28,94,1,0,1.3,0,0,0)
create_explo_circle(room_width*0.7,room_height*0.35,80-28,84,1,0,1.3,0,0,0)


create_explo_circle(room_width*0.3,room_height*0.65,119-28,35,1,0,1.3,0,0,0)
create_explo_circle(room_width*0.5,room_height*0.65,129-28,25,1,0,1.3,0,0,0)
create_explo_circle(room_width*0.7,room_height*0.65,139-28,15,1,0,1.3,0,0,0)
