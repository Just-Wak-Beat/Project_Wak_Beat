...
if (global.t_selected_difficulty == 0)
{
	for(var i = -4; i <= 4; i++)
	{
		...
		create_cylinder(room_width*0.8+i*68,global.c_h-8*abs(22)*(1+abs(i)),depth+15,0.5,1,64,270,0,false);
	}
	
	repeat(irandom_range(8,12))
	{
		var attack_ef = instance_create_depth(room_width*0.8,global.c_h+irandom_range(-64,64),obj_player.depth+15,hitbox_2);
