...
if (audio_is_playing(happysegu))
{
	...
	draw_sprite_ext(spr_eye1,1,x+lengthdir_x(target_eye_dis,target_eye_angle),y+lengthdir_y(target_eye_dis,target_eye_angle),scale_xscale*1,scale_yscale*1,image_angle,image_blend,(global.timeline_stop != 1) ? image_alpha : 0.4)
}