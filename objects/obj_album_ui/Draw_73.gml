...
{
draw_sprite_ext(spr_triangle,key_Lpressed,__xx-500,global.c_y+64-(1 - ui_alpha__cal)*1880,0.1,0.1,90,c_white,ui_alpha__cal)
draw_sprite_ext(spr_triangle,key_Rpressed,__xx+500,global.c_y+64-(1 - ui_alpha__cal)*1880,0.1,0.1,-90,c_white,ui_alpha__cal)
}
...
{
draw_set_alpha(global.sync_setting_alpha)
...
draw_line_width(global.c_x,global.c_y,global.c_w,global.c_h,room_width)
	...
	draw_sprite_ext(sprite__,0,xx+xx_w*0.5+i*256,yy+yy_h*0.5,scale,scale,0,c_white,global.sync_setting_alpha)
...
draw_text_k_scale(xx+xx_w-64,yy+yy_h*0.85,"강제 싱크 맞추기",64,-1,global.sync_setting_alpha,c_white,0,1,normal_font,fontsize2*global.font_ratio_resolution_xx,fontsize2,0)
