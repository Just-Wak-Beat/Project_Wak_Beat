...
if (sprite_index == spr_hexagon)
{
	...
	{
		draw_sprite_ext(sprite_index,image_index,x,y,image_xscale*0.9,image_yscale*0.9,image_angle+30,merge_color(c_black,global.background_color,fix_num(global.t_bg_color_alpha)),image_alpha)
