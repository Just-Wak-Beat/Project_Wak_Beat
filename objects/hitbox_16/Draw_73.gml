...
if (global.timeline_stop == 1)
{
	...
	if (global.editor_hitbox == 1 && editor_selected == 1)
	{
		...
		draw_set_alpha(1);
		draw_line_width(x,y,x+lengthdir_x(320,180+image_angle),y+lengthdir_y(320,180+image_angle),3);
	
		
		var fontsize2 = (0.45*(1+global.mobile_mode*0.3))*global.converted_view_ratio;
		draw_text_k_scale(x,y+64,"Size : "+string(image_xscale)+"\nx : "+string(floor(x))+"\ny : "+string(floor(y))+"\nSpeed : "+string(ed_arg2),64,-1,1,c_white,0,0,normal_font,fontsize2*global.font_ratio_resolution_xx,fontsize2,0)
	}
}