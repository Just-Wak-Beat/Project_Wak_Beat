...
if global.mobile_mode = 1
{
	...
	display_ratio[0] = floor((display_height/display_width)*10)
	display_ratio[1] = floor((display_width/display_height)*10)

	for(var i = 0; i <= 1; i++)
	{
		if (display_ratio[i] = floor(16/10*10))
		{
