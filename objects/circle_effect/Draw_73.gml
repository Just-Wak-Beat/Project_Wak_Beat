...
draw_set_alpha(1)
var color__bg = merge_color_new(#373b40,global.map_color,0.2)
var col_cal = merge_color_new(color__bg,c_white,global.background_w_alpha)
var cal_2 = merge_color_new(col_cal,global.map_color,image_alpha)
draw_set_color(merge_color_new(cal_2,c_white,w_alpha))
for(var i = -4; i <= 4; i++)
{
