...
if (global.timeline_stop == 1)
{
	...
	{
		draw_text_k_scale(x,y-64,"카메라 지진 효과",64,-1,1,c_white,0,0,normal_font,fontsize2*global.font_ratio_resolution_xx,fontsize2,0)
		draw_sprite_ext(spr_various_effect,6,x,y,image_xscale,image_yscale,image_angle,global.player_color,image_alpha)
	}
}