...
if (image_alpha > 0)
{
	if (!variable_instance_exists(id,"none_color_change") && circle_w_alpha > 0 && sprite_index != spr_rain && effect_projectile != 1 && !variable_instance_exists(id,"no_w_effect"))
	{
	...
	draw_self()
	if (w_alpha > 0 && !variable_instance_exists(id,"no_w_effect"))
	{
