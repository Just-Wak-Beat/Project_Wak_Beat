...
if (sprite_index == spr_spuare_outline && audio_is_playing(roki))
{
	...
	draw_sprite_ext(spr_triangle,0,x-image_xscale*32,y-image_yscale*40,scale_xscale2,scale_yscale2,35,merge_color_new(image_blend,c_white,tmp_w_alpha),image_alpha)
	draw_sprite_ext(spr_triangle,1,x+image_xscale*32,y-image_yscale*40,scale_xscale2,scale_yscale2,-35,merge_color_new(image_blend,c_white,tmp_w_alpha),image_alpha)
}